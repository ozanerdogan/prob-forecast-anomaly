...
run.
  ...
  python scripts/analysis/run_significance.py --pred-dir results/predictions_smoke
"""
...
def main() -> None:
    ...
    if y_true is None:
        raise SystemExit(f"no clean test dumps in {pred_dir} (run scripts/analysis/run_anomaly_eval.py)")
