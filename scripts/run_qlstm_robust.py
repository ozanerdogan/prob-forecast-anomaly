...
Same augmenter as run_robust_training.py (p=0.5 per-batch injection, seed 42),
dumped over the v2 fault catalog by default.

  python scripts/run_qlstm_robust.py
  python scripts/run_qlstm_robust.py --smoke
"""
...
from run_robust_training import make_augmenter  # noqa: E402
